...
class _YoloVideoState extends State<YoloVideo> {
  ...
  Future<void> yoloOnFrame(CameraImage cameraImage) async {
    ...
    if (currentTime.difference(lastProcessed).inMilliseconds < frameDelayMs) {
      return; 
    }
    ...
    // Clear the bounding box after 5 seconds if no detection is detected
    if (currentTime.difference(lastDetectionTime).inSeconds >= 5) {
      setState(() {
        yoloResults.clear(); 
      });
    }
